...
public class DataBaseHandler {
    ...
    static{
        try {
            ...
            //new String(System.console().readPassword("Пароль:"))
            try {
                connection = DriverManager.getConnection("jdbc:postgresql://pg/studs", "s285700", "PASSWORD");
            }catch(Exception e){
                connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/postgres", "postgres", "lordling");
            }
